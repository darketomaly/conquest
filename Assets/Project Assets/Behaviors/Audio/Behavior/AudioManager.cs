...
namespace Conquest.Audio {
    ...
    public class AudioManager : MonoBehaviour {
        ...
        [SerializeField] private AudioSource mainSource;   //used to play sound effects
        [SerializeField] private AudioSource musicSource1; //used to crossfade music
        [SerializeField] private AudioSource musicSource2; //used to crossfade music
        ...
        /// <summary> Crossfades a song if it's playing </summary>
        public static void Play2D(Music music) {

            m.musicSource1.DOKill();
            m.musicSource2.DOKill();
        ...
        private AudioClip GetClip(Music music) => dictionary[music.ToString()];

        private AudioClip GetClip(Sfx sfx) => dictionary[sfx.ToString()];
    }
}